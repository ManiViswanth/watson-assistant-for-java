...
import com.ibm.watson.developer_cloud.http1.RequestBuilder;
 ...
 */
public class MisawaTokenManager {
  ...
  public MisawaTokenManager(String apiKey) {
    this.apiKey = apiKey;
    this.url =DEFAULT_IAM_URL;
    
    this.userManagedAccessToken = null;
